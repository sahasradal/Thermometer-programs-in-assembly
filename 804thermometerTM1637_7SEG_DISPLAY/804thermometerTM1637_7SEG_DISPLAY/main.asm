;
; 804thermometerTM1637_7SEG_DISPLAY.asm
; tested OK
; Created: 03/05/2022 11:01:51
; Author : Manama
;
...
check1:
	rcall bit_read				; call bit read function, if convert finished (sensor does not pull line low) high (1) else low if busy (0)
	sbrs r24,7					; check r24 for bit status read and loaded by bit_read function
	rjmp check1					; if msb of r24 is clear loop to check1 label until msb becomes 1 (0 means conversion still going on-sensor busy)
